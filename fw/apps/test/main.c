...
int main(void) {
  ...
  while(1) {
      palSetPad(GPIOA, GPIOA_OUT1);
      chThdSleepMilliseconds(250);
      palSetPad(GPIOA, GPIOA_OUT2);
      chThdSleepMilliseconds(250);
      palSetPad(GPIOA, GPIOA_OUT3);
      chThdSleepMilliseconds(250);
      palSetPad(GPIOA, GPIOA_OUT4);
      chThdSleepMilliseconds(250);

      palClearPad(GPIOA, GPIOA_OUT1);
      chThdSleepMilliseconds(250);
      palClearPad(GPIOA, GPIOA_OUT2);
      chThdSleepMilliseconds(250);
      palClearPad(GPIOA, GPIOA_OUT3);
      chThdSleepMilliseconds(250);
      palClearPad(GPIOA, GPIOA_OUT4);
      chThdSleepMilliseconds(250);
  }
