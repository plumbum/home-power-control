 ...
 */
#define BOARD_HPC
#define BOARD_NAME              "Home Power Control (HPC)"
...
#define GPIOB_BUTTON1           8
#define GPIOB_BUTTON2           9
 ...
 * PA0  - Pulled input (USB P).
 * PA1  - Push Pull output (USB DISC).
 * PA11 - Normal input      (USB DM).
 * PA12 - Normal input      (USB DP).
 */
#define VAL_GPIOACRL            0x33338838      /*  PA7...PA0 */
#define VAL_GPIOACRH            0x388448B8      /* PA15...PA8 */
#define VAL_GPIOAODR            0xFFFF7F0F
